...
public class SecurityConfiguration {
    ...
    private static final String[] WHITE_LIST_URL = {"/api/v1/auth/**","/api/v1/business/**","/api/v1/user/**","/api/v1/image/**", "/api/v1/dogs/**", "/api/v1/appointment/**","/api/v1/auth/business-type/dog-sitter"};
