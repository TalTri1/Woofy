    ...
    >
      ...
      >
        <Typography
          variant="h3"
          component="b"
          sx={{ fontWeight: "bold", lineHeight: 1.2, fontSize: { xs: "2.5rem", md: "3.5rem" } }}
        >
          Happy Customers
        </Typography>
        <Typography variant="body1" sx={{ fontSize: "18px", lineHeight: "1.5", whiteSpace: "nowrap" }}>
          Read what our satisfied dog owners and owners have to say about Woofy
        </Typography>
      </Box>
      <Box
        component="footer"
      ...
      >
        <Box sx={{ display: "flex", flexDirection: "column", alignItems: "start", justifyContent: "start", maxWidth: "100%" }}>
          <Box
            sx={{
              display: "flex",
              flexDirection: "row",
