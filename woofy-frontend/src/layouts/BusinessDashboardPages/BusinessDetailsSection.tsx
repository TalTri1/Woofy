...
import TypesOfServiceRow from "../BusinessDashboardPages/components/TypesOfServiceRow";
import AvailibilityOfServicesRow from "../BusinessDashboardPages/components/AvailibilityOfServicesRow";
import AboutServices from "../BusinessDashboardPages/components/AboutServicesRow";

const BusinessDetailsSection: FunctionComponent = () => {
    return (
        <div className="w-full relative bg-text-alternate overflow-hidden flex flex-col items-start justify-start leading-[normal] tracking-[normal]">
            ...
            <main className="self-stretch flex flex-row items-start justify-start max-w-full text-left text-base text-text-primary font-text-medium-normal mq1050:pl-5 mq1050:pr-5 mq1050:box-border">
                <div className="w-[312px] bg-text-alternate overflow-hidden shrink-0 flex flex-col items-start justify-start pt-0 px-0 pb-[1548px] box-border lg:pb-[654px] lg:box-border mq1050:hidden mq750:pb-[425px] mq750:box-border">
