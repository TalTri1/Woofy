...
> = ({
  ...
  showSeniorRadioButton = false,
    ...
    return (
      <form
        className="m-0 w-[600px] flex flex-col items-start justify-start py-0 px-5 box-border gap-[24px] max-w-full">
        ...
        <div className="self-stretch flex flex-col items-start justify-start gap-[8px] max-w-full">
          ...
          <textarea
            className="bg-background-color-primary [outline:none] self-stretch h-[100px] box-border flex flex-row items-start justify-start pt-0.5 pb-[1.8px] pr-0.5 pl-3 font-text-medium-normal text-base text-color-neutral-neutral border-[1px] border-solid border-color-neutral-neutral-light"
