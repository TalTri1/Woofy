...
const SignUpModal: FunctionComponent = () => {
  ...
  return (
    <div className="w-[480px] rounded-mini bg-background-color-primary flex flex-col items-start justify-start pt-12 px-12 pb-[76px] box-border gap-[30px] max-w-full text-center text-21xl text-text-primary font-text-medium-normal mq700:gap-[15px] mq700:pl-6 mq700:pr-6 mq700:box-border mq900:pt-[31px] mq900:pb-[49px] mq900:box-border">
      ...
      <form className="m-0 self-stretch h-[416px] flex flex-col items-start justify-start gap-[15.5px] max-w-full mq450:h-auto">
        <div className="self-stretch h-[50px] bg-background-color-primary box-border flex flex-row items-start justify-start p-3 max-w-full shrink-0 border-[1px] border-solid border-color-neutral-neutral-lighter">
          <input
        ...
        <div className="self-stretch h-[50px] bg-background-color-primary box-border flex flex-row items-start justify-start p-3 gap-[8px] max-w-full shrink-0 border-[1px] border-solid border-color-neutral-neutral-lighter">
          <input
        ...
        <div className="self-stretch h-8 flex flex-row items-start justify-start pt-4 px-0 pb-[15px] box-border max-w-full shrink-0">
        ...
        <button className="cursor-pointer py-3 px-5 bg-[transparent] self-stretch h-[50px] rounded-11xl box-border flex flex-row items-start justify-center gap-[12px] shrink-0 border-[1px] border-solid border-color-neutral-neutral-light">
      ...
      <div className="flex flex-row items-start justify-start py-0 pr-[49px] pl-[49.5px] text-lg mq450:pl-5 mq450:pr-5 mq450:box-border">
